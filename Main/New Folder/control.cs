...
public class control : MonoBehaviour {
    ...
    public enum PlayerStance { Standing, Crouching, Prone, Gliding, Simming, Noclip, }
    ...
    private InputAction _glideSlamAction;
    ...
    #region initializate
        private void Awake() {
            ...
            _proneAction = playerActions.Prone;
            _slideAction = playerActions.Slide;
            _glideAction = playerActions.Glide;
            _glideSlamAction = playerActions.GlideSlam;
        ...
        private void SubscribeToInputActions() {
            ...
            _proneAction.performed += OnProne;
    ...
    #region Movement
        ...
        #region Jump
            ...
            private void Jump() {
                if ((_characterController.isGrounded && !_isSliding && _currentStance != PlayerStance.Prone) || _movementSettings.jumpCount > 0) {
        ...
        #endregion
        #region Prone
            private void ToggleProne() => SetStance(_currentStance == PlayerStance.Prone ? PlayerStance.Standing : PlayerStance.Prone);
        ...
        #region Glide
            private bool CanGlide() {
                return !_characterController.isGrounded && !_isGliding && _velocity.y < 0; // && _currentStamina > 0 ; // && _currentStance != PlayerStance.Prone;
            }
